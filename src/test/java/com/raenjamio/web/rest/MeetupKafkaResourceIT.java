...
import com.raenjamio.service.MeetupKafkaConsumer;
...
public class MeetupKafkaResourceIT {
    ...
    @Autowired
    private MeetupKafkaProducer producer;

    @Autowired
    private MeetupKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        MeetupKafkaResource kafkaResource = new MeetupKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/meetup-kafka/publish?message=test"))
