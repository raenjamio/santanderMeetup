    ...
    <b-navbar toggleable="md" type="dark" class="jh-navbar">
        <div class="jh-logo-container float-left">
            ...
            <b-navbar-brand class="logo float-left" b-link to="/">
                ...
                <span v-text="$t('global.title')" class="navbar-title">meetup</span> <span class="navbar-version">{{version}}</span>
            </b-navbar-brand>
        </div>
            ...
            <b-navbar-nav class="ml-auto">
                ...
                <b-nav-item-dropdown
                    ...
                    <span slot="button-content" class="navbar-dropdown-menu">
                        ...
                        <span v-text="$t('global.menu.admin.meetup')">Admin Meetup</span>
                    </span>
                    <b-dropdown-item to="/entity/admin/count-beer">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.meetup.count.beer')">Count Beer</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/entity/follow">
                        <font-awesome-icon icon="asterisk" />
                ...
                <b-nav-item-dropdown
                    ...
                    <b-dropdown-item to="/entity/meetup">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.meetup')">Meetup</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/entity/follow">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.follow')">Follow</span>
