...
import com.raenjamio.repository.NotificationRepository;
...
public class NotificationService {
    ...
    public List<Notification> findAllByUser(String idUser) {
        return notificationRepository.findAllByUser(idUser);
    }
}
